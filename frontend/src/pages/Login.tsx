...
/**
 * The product thesis as a drawing: shared history splits into the machine
 * baseline (green) and the analyst's line (amber); the shaded gap is the Delta.
 * Charts stay LTR regardless of page direction, matching the app's convention.
 */
function DeltaMotif() {
  const { t } = useLang()
